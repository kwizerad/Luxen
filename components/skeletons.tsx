  ...
  return (
    <div className="min-h-[calc(100vh-80px)] pb-24 animate-in fade-in duration-200">
      <div className="container mx-auto max-w-2xl px-4 py-3 sm:py-5">
        ...
        {/* Services grid matching exact cards */}
        <div className="grid gap-4 sm:grid-cols-2">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-4xl">
        ...
        <div className="text-center mb-8 space-y-2">
          <div className="h-8 w-56 rounded-lg bg-muted animate-pulse mx-auto" />
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
          {[0, 1].map((i) => (
            <div
              key={i}
              className="rounded-2xl border-2 border-muted/50 bg-card p-6 space-y-4"
            >
        ...
        <div className="mt-8 text-center">
          <div className="h-9 w-24 rounded-lg bg-muted animate-pulse mx-auto" />
        </div>
      </div>
    </div>
  );
