...
import { ImageIcon, Type, RotateCcw, Save, Eye, Globe, Upload } from "lucide-react";
import { toast } from "sonner";
import { ImageUpload } from "./image-upload";

export function BrandingCustomizer() {
  const { config, setSystemName, setLogoUrl, setLogoText, setAdminEmail, saveConfig, resetToDefault } = useBrandingConfig();
    ...
    <div className="space-y-4">
      ...
      <Card className={cardHoverClass}>
        <CardHeader className="pb-2">
          ...
          <CardDescription className="text-xs">
            Change the primary admin email for authentication
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-3">
