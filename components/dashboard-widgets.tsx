...
export function KPICard({ title, value, unit, icon, trend, description, onClick }: KPICardProps) {
  return (
    <Card
...
export function StatBadge({ label, value, icon, variant = 'default', size = 'md' }: StatBadgeProps) {
