...
import { ChevronLeft, ChevronRight, Clock, CheckCircle2, Circle, Lock, Volume2 } from "lucide-react";
      ...
      <div className="relative overflow-hidden">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Topic text-to-speech audio */}
            {currentTopic.audioUrl && (
              <div className="p-3.5 rounded-[14px] bg-green-500/10 border border-green-500/20 flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <div className="flex items-center gap-2 text-green-700 dark:text-green-300 text-xs font-semibold flex-shrink-0">
                  <Volume2 className="h-4 w-4" />
                  <span>Audio Lesson</span>
                </div>
                <audio controls src={currentTopic.audioUrl} className="h-8 w-full max-w-md rounded-md" />
              </div>
            )}
