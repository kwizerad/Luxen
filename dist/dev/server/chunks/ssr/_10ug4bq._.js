...
"[project]/lib/exam-settings.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/exam-settings.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
async function getExamCategories() {
    ...
    const isUserAdmin = user && (user.email?.toLowerCase() === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PRIMARY_ADMIN_EMAIL"].toLowerCase() || user.user_metadata?.role === "Admin");
...
async function createExamCategory(name, is_published = false) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    const { data: { user } } = await supabase.auth.getUser();
    const isPrimaryAdmin = user?.email?.toLowerCase() === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PRIMARY_ADMIN_EMAIL"].toLowerCase();
...
async function getExamQuestions(categoryId) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    const { data: { user } } = await supabase.auth.getUser();
    if (!user || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAdmin"])(user)) {
...
async function createExamQuestion(questionData) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canAddQuestions"])(user)) {
...
async function updateExamQuestion(id, updateData) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasReadWriteQuestionAccess"])(user)) {
...
async function getExamAttempts(userId, attemptId) {
    ...
    if (attemptId) {
        ...
        if (attempt.user_id !== user.id && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAdmin"])(user)) {
            throw new Error("Unauthorized");
        }
        return {
            attempt
    ...
    if (userId) {
        if (userId !== user.id && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAdmin"])(user)) {
            throw new Error("Unauthorized");
        }
...
async function getExamSettings(categoryId) {
    ...
    return {
        categoryId,
        settings: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeExamSettings"])(data ?? undefined)
    };
}
async function updateExamSettings(categoryId, settings) {
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])();
    const { data: { user } } = await supabase.auth.getUser();
    if (!user || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canManageExamSettings"])(user)) {
        throw new Error("Unauthorized");
    }
    if (!categoryId) {
    ...
    return {
        categoryId,
        settings: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeExamSettings"])(data)
    };
}
async function getExamLimits(userId) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAdmin"])(user)) {
...
async function getExamForTaking(categoryId) {
    ...
    const settings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeExamSettings"])(rawSettings ?? undefined);
    const now = new Date();
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isWithinAvailabilityWindow"])(now, settings.available_from, settings.available_to)) {
    ...
    const withPic = typedQuestions.filter(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["questionHasAnyImage"]);
    const textOnly = typedQuestions.filter((q)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["questionHasAnyImage"])(q));
    let picked = [];
    const mode = settings.sorting_mode;
    const count = settings.question_count;
    if (mode === "TEXT_ONLY") {
        picked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shuffle"])(textOnly).slice(0, count);
    } else if (mode === "WITH_PICTURE") {
        picked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shuffle"])(withPic).slice(0, count);
    } else if (mode === "MIXED_50") {
        const half = Math.floor(count / 2);
        const first = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shuffle"])(withPic).slice(0, half);
        const second = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shuffle"])(textOnly).slice(0, count - first.length);
        picked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shuffle"])([
            ...first,
            ...second
        ]).slice(0, count);
    } else {
        // RANDOM
        picked = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$exam$2d$settings$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shuffle"])(typedQuestions).slice(0, count);
    }
...
async function getNotifications(unreadOnly = false, limit = 50) {
    ...
    const isUserAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAdmin"])(user);
...
const typeIcons = {
    ...
    exam: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$text$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__FileText$3e$__["FileText"],
...
function NotificationsDropdown() {
    ...
    const fetchNotifications = async ()=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNotifications"])();
    ...
    const markAsRead = async (notificationId)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markNotificationAsRead"])(notificationId);
    ...
    const markAllAsRead = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["markAllNotificationsAsRead"])();
    ...
    const deleteNotification = async (notificationId)=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$queries$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteNotification"])(notificationId);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$branding$2d$config$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/branding-config.tsx [app-ssr] (ecmascript)");
...
function AdminLayout({ children }) {
    const { config } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$branding$2d$config$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useBrandingConfig"])();
    ...
    const [sidebarMode, setSidebarMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("auto");
    ...
    const [isHoveringSidebar, setIsHoveringSidebar] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isNearSidebarEdge, setIsNearSidebarEdge] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePathname"])();
    const sidebarTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkAdmin = async ()=>{
            try {
                const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentUser"])();
    ...
    const isPrimaryAdmin = user?.email?.toLowerCase() === ADMIN_EMAIL.toLowerCase();
    const canViewStudentsTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canViewStudents"])(user);
    const canAddQuestionsTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canAddQuestions"])(user);
    const canViewQuestionsTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$permissions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["canViewQuestions"])(user);
    const handlePasswordChange = async (e)=>{
        ...
        try {
            ...
            if (passwordError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(passwordError.message);
                return;
            }
            ...
            if (metadataError) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(metadataError.message);
                return;
            }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Failed to change password");
        } finally{
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: config.logoUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                            src: config.logoUrl,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            showPasswordChange && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_10ug4bq._.js.map