...
import { BarChart3, Monitor, Smartphone, Tablet, Globe, Clock, Activity } from "lucide-react";
...
export function DeviceAnalytics({ analytics }: DeviceAnalyticsProps) {
  ...
  const statCards = [
    ...
    { icon: <Activity className="h-4 w-4" />, label: t("totalLogins"), value: analytics.totalLogins.toString() },
  ];
