...
interface UserProfileDrawerProps {
  ...
  onViewIdDetail?: (user: UserWithStatus) => void;
}
              ...
              <div className="flex gap-2 flex-wrap">
                {onViewIdDetail && (
                  <Button
                    ...
                    className="h-8 text-xs sm:text-sm bg-primary/90 hover:bg-primary text-primary-foreground gap-1.5"
                  >
                    <IdCard className="h-3.5 w-3.5" />
                    <span>{t("iremboCard") || "Irembo Official Card"}</span>
                  </Button>
                )}
