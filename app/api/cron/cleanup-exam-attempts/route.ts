...
/**
 * Server-side cron route to purge in-progress exam attempts older than 60 minutes without activity.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("[CronCleanup] Error executing cleanup:", error);
    return NextResponse.json(
